...
export type GenerationDescriptor = { id: string; sessionId: string; mode: GenerationMode; status: string; sequence: number; provider: string; model: string; finalRevision?: number | null; errorCode?: string | null };
